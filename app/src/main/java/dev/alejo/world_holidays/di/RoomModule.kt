...
import dev.alejo.world_holidays.data.database.HolidayNotificationDatabase
...
object RoomModule {
    ...
    private const val HOLIDAY_NOTIFICATION_DATABASE_NAME = "world_holiday_notification_database"
